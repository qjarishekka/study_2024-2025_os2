...
![изменение приоритета](image/27.png){#fig:022	 width=70%}
...
![программа yes](image/28.png){#fig:023	 width=70%}
...
![программп yes ](image/29.png){#fig:024	 width=70%}
...
![nohup yes &](image/45.png){#fig:035	 width=70%}
...
![killall](image/46.png){#fig:036	 width=70%}
...
![сравнение приоритетов](image/47.png){#fig:038	 width=70%}
...
![изменение приоритетов](image/48.png){#fig:039	 width=70%}
