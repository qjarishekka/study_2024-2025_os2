...
![выполнение команд](image/24.png){#fig:019	 width=70%}
...
![изменение приоритета](image/25.png){#fig:020	 width=70%}
...
![изменение приоритета](image/26.png){#fig:021	 width=70%}
...
![программа yes](image/27.png){#fig:023	 width=70%}
...
![программп yes ](image/28.png){#fig:024	 width=70%}
...
![программа yes](image/29.png){#fig:025	 width=70%}
