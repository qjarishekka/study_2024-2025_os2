...
Потом я отмонтировал его (рис. [-@fig:050	]).

		umount /dev/sdg5

![отмонтирование](image/50.png){#fig:050	 width=70%}


Потом я еще раз проверил все (рис. [-@fig:051	]).

		mount

![проверка](image/51.png){#fig:051	 width=70%}
...
![Название](image/placeimg_800_600_tech.png){#fig:04	 width=70%}
